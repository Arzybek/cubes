...
class Button(GameObject):
    def __init__(self, x, y, w, h, text, on_click=lambda x: None, padding=0, size=cfg.font_size):
        super().__init__(x, y, w, h)
        self.state = 'normal'
        self.on_click = on_click
        self.text = TextObject(x + padding, y + padding, text, color=cfg.button_text_color, font_size=size)
        self.text_easy = text
